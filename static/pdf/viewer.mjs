...
const PDFViewerApplication = {
  ...
  async open(args) {
    ...
    return loadingTask.promise.then(pdfDocument => {
      console.log("loadingTask.promise.then(pdfDocument)");
  ...
  async download(options = {}) {
    ...
    try {
      ...
      await customDownload(data, this.pdfDocument);
  ...
  downloadOrSave(options = {}) {
    //console.log("debug - downloadOrSave - this.pdfDocument?.annotationStorage.size = " + this.pdfDocument?.annotationStorage.size);
  ...
  load(pdfDocument) {
    //console.log("debug - load - pdfDocument");
    ...
    //console.log("debug - set - annotationStorage");
    ...
    firstPagePromise.then(pdfPage => {
      ...
      pdfPageWidth = pdfPage.view[2] - pdfPage.view[0];
      pdfPageHeight = pdfPage.view[3] - pdfPage.view[1];
      console.log("page width: " + pdfPageWidth + ", page height: " + pdfPageHeight);
  ...
  async _initializeMetadata(pdfDocument) {
    //console.log("debug - _initializeMetadata - pdfDocument");
    const {
      info,
      metadata,
    ...
    //console.log("debug - contentDispositionFilename");
    //console.log(contentDispositionFilename);

    //console.log("debug - contentLength");
...
const defaultOptions = {
  ...
  workerSrc: {
    value: "../static/pdf/build/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
  let pdfFile = pdfFileForView ? pdfFileForView : PDF_FILE_NAME;
  defaultOptions.defaultUrl = {
    value: "../static/" + pdfFile,
    kind: OptionKind.VIEWER
  };
  defaultOptions.sandboxBundleSrc = {
    value: "../pdf/build/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
...
function getViewerConfiguration() {
  //console.log("debug - get viewer configuration - mainContainer - viewContainer");
  return {
...
function webViewerLoad() {
  // console.log("debug - on webViewerLoad");
...
//console.log("debug - webViewerLoad with document.readyState: " + document.readyState);
if (document.readyState === "interactive" || document.readyState === "complete") {
  //console.log("debug - webViewerLoad case 01");
  webViewerLoad();
} else {
  //console.log("debug - webViewerLoad case 02");
